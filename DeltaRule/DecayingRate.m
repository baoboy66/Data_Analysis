function [w, iterations, e]=DecayingRate(Data, Target, eta, error, epochs, K)
%% Invoke as: [w, iterations, e] = DecayingRate(Data, Target, eta, error, epochs)
...
%%  K: constant value to lower learning rate
%% data set)
%% Output:
